...
import { ChildNonVisualProperties } from "../../pic/non-visual-pic-properties/child-non-visual-pic-properties/child-non-visual-pic-properties";
...
export const createShapePicture = ({
    ...
    new BuilderElement<{ readonly namespace: string }>({
        ...
        children: [
            new BuilderElement({
                name: "pic:nvPicPr",
                children: [createNonVisualDrawingProperties(nonVisualDrawingProperties, "pic:cNvPr"), new ChildNonVisualProperties()],
            }),
