/**
 * VML value formatting helpers for the watermarks' VML elements.
 *
 ...
 * converts JavaScript-friendly values into those conventions. docx has its own
 * `vmlTrueFalse` for its VML shapes, and doesn't export it.
 *
 * @module
 */
