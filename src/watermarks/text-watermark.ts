 ...
 * @module
 */
import { XmlComponent, createVmlShape, uniqueId } from "docx";

import { createPict } from "./vml/pict";
import { createVmlFill } from "./vml/vml-fill";
import { createVmlTextPath } from "./vml/vml-text-path";
import { vmlColorValue } from "./vml/vml-values";
import { WORD_ART_SHAPE_TYPE_ID, createWordArtShapeType } from "./vml/word-art-shape-type";
