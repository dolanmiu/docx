...
Adjustments change the proportions of a [shape](usage/shapes.md), the same way as dragging its yellow handles in Word. This page lists the adjustments of every shape that has them. Shapes that aren't listed, such as `rect`, `ellipse` and the flowchart shapes, have none.
...
- The OOXML column gives the name of the shape guide each adjustment is written to, for reading the XML or the [preset shape definitions](https://www.ecma-international.org/publications-and-standards/standards/ecma-376/).

<!-- cspell:disable -->

| Shape                    | Adjustment                 | Description                                                                                           | Default   | OOXML  |
| ------------------------ | -------------------------- | ----------------------------------------------------------------------------------------------------- | --------- | ------ |
| `accentBorderCallout1`   | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
...
| `accentBorderCallout2`   | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
...
| `accentBorderCallout3`   | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
...
| `accentCallout1`         | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-38.333` | `adj4` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.5`   | `adj3` |
| `accentCallout2`         | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `bendX`                    | Bend in the callout line, from the left edge, as a percent of the width                               | `-16.667` | `adj4` |
|                          | `bendY`                    | Bend in the callout line, from the top edge, as a percent of the height                               | `18.75`   | `adj3` |
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-46.667` | `adj6` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.5`   | `adj5` |
| `accentCallout3`         | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `firstBendX`               | First bend in the callout line, from the left edge, as a percent of the width                         | `-16.667` | `adj4` |
|                          | `firstBendY`               | First bend in the callout line, from the top edge, as a percent of the height                         | `18.75`   | `adj3` |
|                          | `secondBendX`              | Second bend in the callout line, from the left edge, as a percent of the width                        | `-16.667` | `adj6` |
...
| `bentConnector3`         | `bendX`                    | Where the connector bends, from the left edge, as a percent of the width                              | `50`      | `adj1` |
| `bentConnector4`         | `firstBendX`               | Where the connector first bends, from the left edge, as a percent of the width                        | `50`      | `adj1` |
|                          | `secondBendY`              | Where the connector bends a second time, from the top edge, as a percent of the height                | `50`      | `adj2` |
| `bentConnector5`         | `firstBendX`               | Where the connector first bends, from the left edge, as a percent of the width                        | `50`      | `adj1` |
|                          | `secondBendY`              | Where the connector bends a second time, from the top edge, as a percent of the height                | `50`      | `adj2` |
...
|                          | `headWidth`                | Width of the arrowhead, as a percent of the shorter side                                              | `50`      | `adj2` |
|                          | `headLength`               | Length of the arrowhead, as a percent of the shorter side                                             | `25`      | `adj3` |
| `bevel`                  | `bevelWidth`               | Width of the bevelled edge, as a percent of the shorter side                                          | `12.5`    | `adj`  |
...
| `borderCallout1`         | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-38.333` | `adj4` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.5`   | `adj3` |
| `borderCallout2`         | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `bendX`                    | Bend in the callout line, from the left edge, as a percent of the width                               | `-16.667` | `adj4` |
|                          | `bendY`                    | Bend in the callout line, from the top edge, as a percent of the height                               | `18.75`   | `adj3` |
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-46.667` | `adj6` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.5`   | `adj5` |
| `borderCallout3`         | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `firstBendX`               | First bend in the callout line, from the left edge, as a percent of the width                         | `-16.667` | `adj4` |
|                          | `firstBendY`               | First bend in the callout line, from the top edge, as a percent of the height                         | `18.75`   | `adj3` |
|                          | `secondBendX`              | Second bend in the callout line, from the left edge, as a percent of the width                        | `-16.667` | `adj6` |
...
| `callout1`               | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-38.333` | `adj4` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.5`   | `adj3` |
| `callout2`               | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `bendX`                    | Bend in the callout line, from the left edge, as a percent of the width                               | `-16.667` | `adj4` |
|                          | `bendY`                    | Bend in the callout line, from the top edge, as a percent of the height                               | `18.75`   | `adj3` |
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-46.667` | `adj6` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.5`   | `adj5` |
| `callout3`               | `lineStartX`               | Start of the callout line, from the left edge, as a percent of the width                              | `-8.333`  | `adj2` |
|                          | `lineStartY`               | Start of the callout line, from the top edge, as a percent of the height                              | `18.75`   | `adj1` |
|                          | `firstBendX`               | First bend in the callout line, from the left edge, as a percent of the width                         | `-16.667` | `adj4` |
|                          | `firstBendY`               | First bend in the callout line, from the top edge, as a percent of the height                         | `18.75`   | `adj3` |
|                          | `secondBendX`              | Second bend in the callout line, from the left edge, as a percent of the width                        | `-16.667` | `adj6` |
...
|                          | `lineEndX`                 | End of the callout line, where it points, from the left edge, as a percent of the width               | `-8.333`  | `adj8` |
|                          | `lineEndY`                 | End of the callout line, where it points, from the top edge, as a percent of the height               | `112.963` | `adj7` |
| `can`                    | `topHeight`                | Height of the elliptical top, as a percent of the shorter side                                        | `25`      | `adj`  |
...
| `corner`                 | `horizontalArmThickness`   | Thickness of the horizontal arm, as a percent of the shorter side                                     | `50`      | `adj1` |
...
| `curvedConnector3`       | `bendX`                    | Where the connector bends, from the left edge, as a percent of the width                              | `50`      | `adj1` |
| `curvedConnector4`       | `firstBendX`               | Where the connector first bends, from the left edge, as a percent of the width                        | `50`      | `adj1` |
|                          | `secondBendY`              | Where the connector bends a second time, from the top edge, as a percent of the height                | `50`      | `adj2` |
| `curvedConnector5`       | `firstBendX`               | Where the connector first bends, from the left edge, as a percent of the width                        | `50`      | `adj1` |
|                          | `secondBendY`              | Where the connector bends a second time, from the top edge, as a percent of the height                | `50`      | `adj2` |
|                          | `thirdBendX`               | Where the connector bends a third time, from the left edge, as a percent of the width                 | `50`      | `adj3` |
...
|                          | `headWidth`                | Width of the arrowhead, as a percent of the shorter side                                              | `50`      | `adj2` |
|                          | `headLength`               | Length of the arrowhead, as a percent of the shorter side                                             | `25`      | `adj3` |
| `diagStripe`             | `stripeWidth`              | How much of the top and left edges the stripe covers, as a percent of the width and height            | `50`      | `adj`  |
...
| `ellipseRibbon`          | `thickness`                | Thickness of the ribbon, as a percent of the height                                                   | `25`      | `adj1` |
...
| `ellipseRibbon2`         | `thickness`                | Thickness of the ribbon, as a percent of the height                                                   | `25`      | `adj1` |
|                          | `centerWidth`              | Width of the centre section, as a percent of the width                                                | `50`      | `adj2` |
|                          | `curveDepth`               | How far the ribbon curves, as a percent of the height                                                 | `12.5`    | `adj3` |
...
| `homePlate`              | `pointLength`              | Length of the point, as a percent of the shorter side                                                 | `50`      | `adj`  |
...
| `noSmoking`              | `thickness`                | Thickness of the ring and the bar, as a percent of the shorter side                                   | `18.75`   | `adj`  |
...
| `plus`                   | `cornerSize`               | Size of the cut-away corners, as a percent of the shorter side. Larger values make thinner arms       | `25`      | `adj`  |
...
| `ribbon`                 | `endOffset`                | How far the ends are offset from the centre section, as a percent of the height                       | `16.667`  | `adj1` |
|                          | `centerWidth`              | Width of the centre section, as a percent of the width                                                | `50`      | `adj2` |
| `ribbon2`                | `endOffset`                | How far the ends are offset from the centre section, as a percent of the height                       | `16.667`  | `adj1` |
|                          | `centerWidth`              | Width of the centre section, as a percent of the width                                                | `50`      | `adj2` |
...
| `round1Rect`             | `cornerRadius`             | Radius of the top-right corner, as a percent of the shorter side                                      | `16.667`  | `adj`  |
| `round2DiagRect`         | `topLeftBottomRightRadius` | Radius of the top-left and bottom-right corners, as a percent of the shorter side                     | `16.667`  | `adj1` |
|                          | `topRightBottomLeftRadius` | Radius of the top-right and bottom-left corners, as a percent of the shorter side                     | `0`       | `adj2` |
| `round2SameRect`         | `topCornerRadius`          | Radius of the top corners, as a percent of the shorter side                                           | `16.667`  | `adj1` |
|                          | `bottomCornerRadius`       | Radius of the bottom corners, as a percent of the shorter side                                        | `0`       | `adj2` |
| `roundRect`              | `cornerRadius`             | Radius of the corners, as a percent of the shorter side. 50 makes the ends fully round                | `16.667`  | `adj`  |
| `smileyFace`             | `smile`                    | How much the mouth curves, as a percent of the height. Negative values frown                          | `4.653`   | `adj`  |
| `snip1Rect`              | `cornerSize`               | Size of the cut top-right corner, as a percent of the shorter side                                    | `16.667`  | `adj`  |
| `snip2DiagRect`          | `topLeftBottomRightSize`   | Size of the cut top-left and bottom-right corners, as a percent of the shorter side                   | `0`       | `adj1` |
|                          | `topRightBottomLeftSize`   | Size of the cut top-right and bottom-left corners, as a percent of the shorter side                   | `16.667`  | `adj2` |
| `snip2SameRect`          | `topCornerSize`            | Size of the cut top corners, as a percent of the shorter side                                         | `16.667`  | `adj1` |
|                          | `bottomCornerSize`         | Size of the cut bottom corners, as a percent of the shorter side                                      | `0`       | `adj2` |
| `snipRoundRect`          | `roundedCornerRadius`      | Radius of the rounded top-left corner, as a percent of the shorter side                               | `16.667`  | `adj1` |
...
|                          | `skew`                     | Shifts the waves sideways, as a percent of the width, from -10 to 10                                  | `0`       | `adj2` |
| `wedgeEllipseCallout`    | `pointerX`                 | Tip of the pointer, from the centre, as a percent of the width. Negative values are to the left       | `-20.833` | `adj1` |
|                          | `pointerY`                 | Tip of the pointer, from the centre, as a percent of the height. Negative values are above the centre | `62.5`    | `adj2` |
| `wedgeRectCallout`       | `pointerX`                 | Tip of the pointer, from the centre, as a percent of the width. Negative values are to the left       | `-20.833` | `adj1` |
|                          | `pointerY`                 | Tip of the pointer, from the centre, as a percent of the height. Negative values are above the centre | `62.5`    | `adj2` |
| `wedgeRoundRectCallout`  | `pointerX`                 | Tip of the pointer, from the centre, as a percent of the width. Negative values are to the left       | `-20.833` | `adj1` |
|                          | `pointerY`                 | Tip of the pointer, from the centre, as a percent of the height. Negative values are above the centre | `62.5`    | `adj2` |
